...
#    df_ana_01['opentime'] = 'NaN'
#    df_ana_01['openstkp'] = float('NaN')
#    df_ana_01['stattime'] = 'NaN'
#    df_ana_01['captureopen'] = float('NaN')
#    df_ana_01['captureclose'] = float('NaN')
#    df_ana_01['statstkp'] = float('NaN')
    
    #print df_ana_01
    #df_ana_01.set_index(('opendate', 'amin')).reset_index(col_level=0)
    #df_ana_01.reset_index(inplace=True,col_level=1)  
    #df_ana_02 = df_ana_01.rename(columns={"('opendate', 'amin')" : "opendate"}, inplace=True)
    
    
    print df_ana_01

    #print(list(df_ana_02.columns.values))
    
#    for index_01, row_01 in df_ana_01.iterrows():    
#        openshortopenlongoptsym = index_01
#        opendate = row_01[('opendate', 'amin')]
##        print '----------------------'
