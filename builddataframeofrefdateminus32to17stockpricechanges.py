...
#    DataFrameResult = property(get_DataFrameResult, set_DataFrameResult)   
    ...
    def build(self,
        ...
        for idx, row in df.iterrows():
            ...
            df.loc[dRef] = pd.Series({'pRef':pRef, 'd1':d17, 'p1':p17,'d2':d32,'p2':p32,'Delta2to1':pdelta32to17,'DrawDownMax':pDraw_downmax,'DrawUpMax':pDraw_upmax,'DrawDownPctChange':pctchangeDraw_downmax,'DrawUpPctChange':pctchangeDraw_upmax})
