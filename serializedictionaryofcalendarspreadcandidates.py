...
class serialize:
    def __init__(self,
                 dictionaryofcalendarspreadcandidates,
                 maxnumberofcandidates = 1000,
                 showresults=0):
        print('initialized class serializedictionaryofcalendarspreadcandidatestoxml.py ')
        self.execute_serialize(dictionaryofcalendarspreadcandidates,maxnumberofcandidates,showresults)
...
#    SortbyMeasure = property(get_SortbyMeasure, set_SortbyMeasure)    
    ...
    def execute_serialize(self,dictionaryofcalendarspreadcandidates,maxnumberofcandidates,showresults):
        print('------')
        import mytools
        ...
        #totalnumberofcandidates = len(dictionaryofcalendarspreadcandidates)
        icandidate = 0
        for k,v in dictionaryofcalendarspreadcandidates.items():
