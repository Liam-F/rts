...
#    SortbyMeasure = property(get_SortbyMeasure, set_SortbyMeasure)    
    ...
    def execute_serialize(self,sortedpairdictionary,showresults):
        ...
        self.Complete = 0
        if len(sortedpairdictionary.items()) > 0:
    ...
    #        import mytools
            ...
            for k,v in sortedpairdictionary.items():
                ...
                quotedatetimeforserializedfile = earlier.quotedatetime
    ...
    #        
            ...
            print('-------------------------------------XXX')
            print('')
            print(len(sortedpairdictionary),'valid pairs serialized')
            print('')
            print('-------------------------------------XXX')
            import os
            directorylocaloutput = os.path.join(os.getcwd(), 'output','calendarspreadcandidates')
            
            import mytools
            directorylocaloutput = mytools.mystrings.appendnormaldateddirectorybasedondatetimeparameter(directorylocaloutput,quotedatetimeforserializedfile)
