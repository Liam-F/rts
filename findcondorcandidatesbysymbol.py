...
class perform:
    def __init__(self,
        ...
        self.find(symbol 
            ...
            ,  myspreadindollars 
            ,  mycumprobthreshold 
            ,  mycumprob_to_sell_price_lowrange 
            ,  mycumprob_to_sell_price_highrange 
            ,  numberofweekstolookback 
            ,  RollingNumberOfPeriods 
            ,  showresults 
            )
    def find(self
            ,  symbol = 'SPY'
...
if __name__=='__main__':
    o = perform(symbol='NFLX',mycumprobthreshold=80)
