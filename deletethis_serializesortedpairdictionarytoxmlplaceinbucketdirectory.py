...
#        
        ...
        import mytools
        directorylocaloutput = mytools.mystrings.appendnormaldateddirectorybasedondatetimeparameter(directorylocaloutput,bucketquotedatetimeforserializedfile)
        ...
        print(datetime14)
        outputfilepath = directorylocaloutput + '\\calendarspreads ' + symbolforserializedfile + ' ' + datetime14 + '.xml'
        #if showresults == 1:
