...
class read:
    ...
    def __init__(self,
                 ...
                 showresults=0):
        print('initialized class serializeallcsvfilesindownloadsdirectory')
        if showresults == 1:
            print('showresults=' + str(showresults) + ' readintomemoryprocessallfilesindirectorylocal')
        
        self.serialize(downloadsdirectory,replacelistforcreatingdestinationpath,showresults)
...
#    DictionaryOfSerializedFileObjects = property(get_DictionaryOfSerializedFileObjects, set_DictionaryOfSerializedFileObjects)   
    ...
    def serialize(self,downloadsdirectory,replacelistforcreatingdestinationpath,showresults):
        ## ########################
