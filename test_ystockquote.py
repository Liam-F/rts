...
class YStockQuoteTestCase(unittest.TestCase):
    ...
    def test_get_historical_prices(self):
        ...
        prices_dict = ystockquote.get_historical_prices(self.symbol, '2014-01-02', '2014-01-15')
        
        print('jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj')
        self.assertIsInstance(prices_dict, dict)
        self.assertEqual(len(prices_dict), 10)
        self.assertEqual(sorted(prices_dict.keys())[0], '2014-01-02')
        self.assertEqual(sorted(prices_dict.keys())[-1], '2014-01-15')
        self.assertGreater(float(prices_dict['2014-01-02']['Open']), 0.0)
        self.assertGreater(float(prices_dict['2014-01-02']['High']), 0.0)
        self.assertGreater(float(prices_dict['2014-01-02']['Low']), 0.0)
        self.assertGreater(float(prices_dict['2014-01-02']['Close']), 0.0)
        self.assertGreater(float(prices_dict['2014-01-02']['Volume']), 0.0)
        self.assertGreater(float(prices_dict['2014-01-02']['Adj Close']), 0.0)
        self.assertGreater(float(prices_dict['2014-01-15']['Open']), 0.0)
        self.assertGreater(float(prices_dict['2014-01-15']['High']), 0.0)
        self.assertGreater(float(prices_dict['2014-01-15']['Low']), 0.0)
        self.assertGreater(float(prices_dict['2014-01-15']['Close']), 0.0)
        self.assertGreater(float(prices_dict['2014-01-15']['Volume']), 0.0)
        self.assertGreater(float(prices_dict['2014-01-15']['Adj Close']), 0.0)
