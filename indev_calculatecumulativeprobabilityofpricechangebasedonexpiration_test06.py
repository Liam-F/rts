...
if showresults == 1:
    ...
    print('---------------------------------')
    print('  ',symbol
            ,'{percent:.2%}'.format(percent=ibeyondabove/len(df_stockpricechanges.index))
            ,'of the'
    ...
    print('---------------------------------')
    print('  ',symbol
            ,'{percent:.2%}'.format(percent=ibeyondbelow/len(df_stockpricechanges.index))
            ,'of the'
            ,len(df_stockpricechanges.index)
...
# Draw Up analysis
print('')
print(symbol,'Draw Up:',len(df_stockpricechanges.index), 'observations',ibeyondabove,'breached',ThreshholdAbove)
...
# Draw Down analysis
print('')
print(symbol,'Draw Down:',len(df_stockpricechanges.index), 'observations',ibeyondabove,'breached',ThreshholdBelow)
print('   ','DaysBackFar',daysbackfar,'   DaysBackMid:',daysbackmid)
...
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
'''
df_candidates.to_csv(myoutputfolder + "\\ironcondor candidates " + symbol +  " " + datestringforfilename + ".csv",columns=('ty','stkp','spdel','sstrk','bstrk','scump','bcump','sbid','bask','capt','myexdate','currdate','daysbackmid','price ' + mycomparesym))
#print(df_candidates)
...
for index,row in df_candidates.iterrows():
    ...
    if row['ty'] == 'P' and crossedthreshold_put == 0 and iter_scump < mycumprobthreshold:
        ...
        capturedspread_at_put_threshold_cross = float(row['capt'])
...
print('    Condor Capture Amt=',capturedspread_at_call_threshold_cross+capturedspread_at_put_threshold_cross)
