...
"""
import os
import readfiltersortserialize
...
iCount = 0
topdirectory = 'C:\\Documents and Settings\\jmalinchak\\My Documents\\My Python\\Active\\py\\downloads\\2015-01-21'
for (topdirectory, dirs, files) in os.walk(topdirectory):
    for directoryname in dirs:
        ...
        if iCount > 0:
            o = readfiltersortserialize.read(directoryname)
