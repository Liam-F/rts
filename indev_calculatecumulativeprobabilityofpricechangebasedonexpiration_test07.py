...
print('Breaches at Finish (Far to Mid):')

print('   ',breachedmycumprobthreshold_total,'of',icountfartomidbeyond_above+icountfartomidbeyond_below,'observations breached ---', '{percent:.2%}'.format(percent=icountfartomidbeyond_above+icountfartomidbeyond_below/float(number_of_observations)))
print('    Up=',icountfartomidbeyond_above,'... Down=',icountfartomidbeyond_below)
